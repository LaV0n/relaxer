...
export const Joke = () => {
   ...
   const background: any = {
      Programming:
         'https://toggl.com/blog/wp-content/uploads/2014/12/01-excited-programmer-comic.png',
      ...
      Spooky:
         'https://dmn-dallas-news-prod.cdn.arcpublishing.com/resizer/Ijz8GLqHuxA1CqG4Gsaf_-ilxdw=/1660x934/filters:focal(1965x1525:1975x1515):no_upscale()/cloudfront-us-east-1.images.arcpublishing.com/dmn/BUCBSDSMMVFX7OIOVB3ZHMWRCQ.jpg',
      Christmas:
         'https://www.history.com/.image/ar_1:1%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cq_auto:good%2Cw_1200/MTY4OTA4MzI0ODc4NjkwMDAw/christmas-tree-gettyimages-1072744106.jpg',
      default:
         'https://thumbs.dreamstime.com/z/no-found-symbol-unsuccessful-search-vecotr-upset-magnifying-glass-cute-not-zoom-icon-suitable-results-oops-page-failure-122786031.jpg',
   }
   ...
   return (
      <div className={styles.container}>
         ...
         <Button onClick={getJokeHandler} variant="contained">
            get JOKE
         </Button>
         <div className={styles.jokeBlock}>
            <img
               src={category && category !== 'Any' ? background[category] : background.default}
               alt="0"
            />
            {joke}
         </div>
